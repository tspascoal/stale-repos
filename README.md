...
* STALE_THRESHOLD_HOURS (optional, default 4320 (180 days)) The maximum time of hours a repo can be inactive until it is considered stale. use zero to disable stale repo marking with a topic
* ARCHIVE_THRESHOLD_HOURS (optional, default 8760 (365 days)) The maximum time of hours a repo can be inactive until it is archived. use zero to disable project archiving
